...
>
> ⚠️ 本文里的 `public/js/main.js:xxxx` 行号对应**扫描当时的基线**。该文件已于 2026-09-24
> 先按 48 个分区拆成 `public/js/app/01…16`、再按职责重排成 `00-prelude.js` + `01…18`（共 19 个），行号不再有效 —— 结论仍然有效，定位请按函数名 grep。
